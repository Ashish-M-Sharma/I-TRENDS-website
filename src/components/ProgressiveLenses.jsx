...
const ProgressiveLenses = () => {
  ...
  const progressiveLenses = [
    {
      ...
      alt: "Image 1",
      name: " Specsmakers Progressive 2",
      price: 5090,
      pPrice: 9999,
      size: "medium",
      gender: "female",
    ...
    {
      id: 3,
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSFxZSy5sWTVB1mBa4UW6doWciwoKAi-qIj_g&s",
      alt: "Image 3",
      name: " Specsmakers Progressive 3",
      price: 2670,
      pPrice: 4500,
      size: "large",
      gender: "unisex",
    ...
    {
      id: 4,
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQX4cFfak0e-796RdY7y5QGNsEDGKuO7FqqOQ&s",
      alt: "Image 4",
      name: " Specsmakers Progressive 4",
      price: 3990,
      pPrice: 4500,
      size: "small",
      gender: "female",
    ...
    {
      id: 5,
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSXmjqcopoKx5vgD2zkzcDWjlf-sGbLegVTtg&s",
      alt: "Image 5",
      name: " Specsmakers Progressive 5",
      price: 1690,
      pPrice: 2000,
      size: "medium",
      gender: "male",
    ...
    {
      id: 6,
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSIpfwotrsqxDNZDVz152zZ0c-9yt0aUtkqbw&s",
      alt: "Image 6",
      name: " Specsmakers Progressive 6",
      price: 4790,
      pPrice: 5000,
      size: "large",
      gender: "unisex",
    ...
    {
      id: 7,
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTjckuI-wPOFGnhcSQIar2QJi8DKNrPBBqdYg&s",
      alt: "Image 7",
      name: " Specsmakers Progressive 7",
      price: 2899,
      pPrice: 3000,
      size: "small",
      gender: "female",
    ...
    {
      id: 8,
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSgeWlhPlwN6uEme3BZaiKrmQP6FMntULJEhw&s",
      alt: "Image 8",
      name: " Specsmakers Progressive 8",
      price: 2690,
      pPrice: 3000,
      size: "medium",
      gender: "male",
  ...
  const filteredLenses = progressiveLenses.filter(
    (lens) =>
